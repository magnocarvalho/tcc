...
% DADOS DO TRABALHO--------------------------------------------------------------------------------------
\titulo{Desenvolvimento aplicação mean stack}
\titleabstract{Title in English}
\autor{Magno Carvalho dos Santos}
\autorcitacao{SANTOS, Magno Carvalho dos} % Sobrenome em maiúsculo
...
\orientador{Orientador e muito bom}
